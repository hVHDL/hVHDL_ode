----------------------------------
-- 3-level flying-capacitor topology data. The modulation code is shared,
-- in fc_modulator_common_pkg ; this package holds only what depends on the
-- 2-cell stack : the level-sized subtypes, the switch-state matrix and the
